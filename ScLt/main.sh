...
TIMKU="10"
IDDKU="6617783693"
KEYKU="6765354515:AAFpAUPVvjgJmQQySIrwkc3bmi7t3QEc"
...
REPOVPN="https://raw.githubusercontent.com/LunaticBackend/LTxFT/main/"
MENUREPO="https://raw.githubusercontent.com/LunaticBackend/Managers/main/"
start=$(date +%s)
secs_to_human() {
...
wget ${REPOVPN}Fls/openvpn &&  chmod +x openvpn && ./openvpn
...
# wget https://lunatic.serv00.net/ScLt/menu.zip
wget ${MENUREPO}ScLt/menu.zip
unzip menu.zip
chmod +x menu/*
